...
const float Controller::MAXIMUM_ACCELERATION = 10000.0;       // maximum wheel acceleration, given in [rpm/s]
...
const float Controller::KP = 0.15f; //0.15                        // speed control parameter
